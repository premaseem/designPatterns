...
public class ObserverShareBroker implements Observer{
	...
	public void update(Observable arg0, Object arg1) {
		System.out.println("Share broker1 got the notification for share price update ");
		System.out.println("He can now choose to pull data from the subject ");
		if (subject != null){
			System.out.println("Latest price of share is "+ subject.getShareprice());
		}
